...
plt.ylabel("$\\mathit{β}$ coefficients", fontsize=26)
...
# fig, ax = plt.subplots(figsize=(6, 6), dpi = 600)
# sns.stripplot(x="Conditions", y="β distributions",
#             hue="Coefficients", palette=["m"],
#             data=df_beta0, dodge=False)
# lc = LineCollection(lines_beta0, colors = "m")
...
#             data=df_beta1, dodge=False)
# lc = LineCollection(lines_beta1, colors = "g")
# ax.add_collection(lc)
# ax.set_title('Interaction threat risk',
#               loc ='left', size = 29)
# # Customize ticks
